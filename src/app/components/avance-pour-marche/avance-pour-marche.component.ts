...
@Component({
  selector: 'app-avance-pour-marche',
  templateUrl: './avance-pour-marche.component.html',
  styleUrls: ['./avance-pour-marche.component.css']
})
export class AvancePourMarcheComponent implements OnInit {
